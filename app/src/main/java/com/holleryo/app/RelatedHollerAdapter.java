 ...
 */
public class RelatedHollerAdapter extends ParseQueryAdapter<Holler> {

    ParseUser user;
    private ProfilePictureView userProfilePictureView;

    public RelatedHollerAdapter(Context context) {

        super(context, new ParseQueryAdapter.QueryFactory<Holler>() {
